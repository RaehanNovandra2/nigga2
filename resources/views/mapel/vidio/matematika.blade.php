...
<body class="bg-blue-900 text-white">
    ...
    <video controls class="w-full h-full object-cover">
        ...
        Your browser does not support the video tag.
            ...
            <!-- Video Description -->
            <div class="w-1/3">
                <h2 class="text-4xl font-bold">Translasi</h2>
                <p class="mt-2">Translasi (Pergeseran) merupakan transformasi yang memindahkan setiap titik pada bidang dengan arah dan jarak tertentu.</p>
            </div>
        </div>
        ...
        <div class="mt-6">
            ...
            <div class="grid grid-cols-3 gap-4">
                ...
                <a href="#">
                 <div class="bg-white shadow-md rounded overflow-hidden">
                <img src="{{ asset('assets/img/refleksi.jpg') }}" alt="Dilatasi" class="w-full h-50 object-cover">
                <div class="p-4">
                    <p class="font-bold text-center">Refleksi</p>
                </div>
            </div>
            </a>
            </button>
