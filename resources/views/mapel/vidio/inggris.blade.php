...
<body class="bg-blue-900 text-white">
    ...
    <video controls class="w-full h-full object-cover">
        ...
        Your browser does not support the video tag.
            ...
            <!-- Video Description -->
            <div class="w-1/3">
                <h2 class="text-4xl font-bold">Speaking Lessons</h2>
                <p class="mt-2">Pelajaran ini berfokus pada pengembangan keterampilan berbicara dalam bahasa Inggris. Siswa diajarkan cara mengucapkan kata-kata dengan benar, membentuk kalimat, dan berkomunikasi dengan lancar. Kegiatan meliputi percakapan, presentasi, dan latihan mendengarkan. Tujuannya adalah meningkatkan kepercayaan diri dan kemampuan siswa dalam berbicara bahasa Inggris sehari-hari.</p>
            </div>
        </div>
        ...
        <div class="mt-6">
            ...
            <div class="grid grid-cols-3 gap-4">
                ...
                <img src="{{ asset('assets/img/writing.jpg') }}" alt="Dilatasi" class="w-full h-50 object-cover">
                <div class="p-4">
                    <p class="font-bold text-center">Writing</p>
                </div>
            </div>
            </a>
            </button>
                ...
                <a href="#">
                 <div class="bg-white shadow-md rounded overflow-hidden">
                <img src="{{ asset('assets/img/listening.jpg') }}" alt="Dilatasi" class="w-full h-50 object-cover">
                <div class="p-4">
                    <p class="font-bold text-center">Listening</p>
                </div>
            </div>
            </a>
            </button>
                ...
                <a href="#">
                 <div class="bg-white shadow-md rounded overflow-hidden">
                <img src="{{ asset('assets/img/reading.jpg') }}" alt="Dilatasi" class="w-full h-50 object-cover">
                <div class="p-4">
                    <p class="font-bold text-center">Reading</p>
                </div>
            </div>
            </a>
            </button>
