...
<body class="bg-white">
    ...
    <!-- Main Content -->
    <div class="px-8">
        <h1 class="text-2xl font-bold mt-4">Materi Bahasa Inggris kelas 12</h1>
        <p class="text-gray-600">Speaking, Writing, and Listening</p>

        <hr class="my-4 border-gray-300 mb-5">
        ...
        <div class="grid grid-cols-3 gap-4">
            ...
            <button>
                ...
                <img src="{{ asset('assets/img/speaking.jpg') }}" alt="Dilatasi" class="w-full h-50 object-cover">
                <div class="p-4">
                    <p class="font-bold text-center">Speaking</p>
                </div>
            </div>
            </a>
            </button>
