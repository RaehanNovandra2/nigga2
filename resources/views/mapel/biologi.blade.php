...
<body class="bg-white">
    ...
    <!-- Main Content -->
    <div class="px-8">
        <h1 class="text-2xl font-bold mt-4">Materi Biologi kelas 12</h1>
        <p class="text-gray-600">Ilmu yang Memperlajari Tentang Makhluk Hidup</p>
        ...
        <div class="grid grid-cols-3 gap-4">
            ...
            <button>
                <a href="#">
                 <div class="bg-white shadow-md rounded overflow-hidden">
                <img src="{{ asset('assets/img/enzim.jpg') }}" alt="Dilatasi" class="w-full h-50 object-cover">
                <div class="p-4">
                    <p class="font-bold text-center">Enzim dan Metabolisme Organisme</p>
                </div>
            </div>
            </a>
            </button>
